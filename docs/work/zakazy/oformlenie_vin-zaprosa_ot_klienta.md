---
title: oformlenie_vin-zaprosa_ot_klienta
createTime: 2025/05/21 12:10:12
---
# Оформление VIN-запроса от клиента
...
![](382.png) – документ был передан с сайта Parts.Resource при тике синхронизации;

![](383.png) – документ был создан из окна звонка. Доступно при наличии подключенной IP-телефонии;

![](384.png) – источник, который можно присвоить документам вручную;

![](385.png) – документ загружен с почты с использованием правила из раздела **CRM ► Автоимпорт заказов клиентов**.
...
При необходимости заполните дополнительную информацию об автомобиле клиента: <b>Тип кузова</b>; <b>Тип топлива</b>; <b>Тип коробки передач</b>; <b>Гос. Номер</b>; <b>Мощность, л.с.</b>; <b>Объем двигателя, см<sup>3</sup></b>; <b>Тип привода</b>; <b>Тип двигателя</b>; количество <b>Подушек безопасности</b>; <b>Правый руль</b>; <b>Количество дверей</b>; <b>Кондиционер</b>, а также <b>Дополнительную информацию</b>.
...
![](009.png)**Создать на основании выделенных**
...
![](011.png)**Приоритетный склад для списания**
