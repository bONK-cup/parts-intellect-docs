...
- **Вес** из карточки товара можно присвоить позициям в прайс-листах поставщиков. Подробнее читайте в разделе [Присваивание веса позициям прайс-листа поставщиков](#8cfa602d-daa9-4020-b725-a739af6b9297).
