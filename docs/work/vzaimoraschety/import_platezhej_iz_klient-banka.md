---
title: Импорт платежей из клиент-банка
...
Перед началом загрузки файла следует убедиться, что выполнены все подготовительные шаги:

В **Настройках пользователя** на вкладке **Основные** указана **Активная** **Наша** **Фирма**.

Счет, по которому идет загрузка платежей, должен соответствовать расчетному счету Нашей фирмы.
...
![](../../assets/work/one/550.png)

![](../../assets/work/one/006.png) **Путь к файлу**

![](../../assets/work/one/551.png)

Позволяет указать полный путь к файлу импорта.

![](../../assets/work/one/008.png) **Формат файла**

![](../../assets/work/one/552.png)

Формат загруженного файла, задается автоматически при указании **Пути к файлу**.

![](../../assets/work/one/009.png) **Виды документов в файле**

![](../../assets/work/one/553.png)
...
![](../../assets/work/one/010.png) **Счет Нашей фирмы**

![](../../assets/work/one/554.png)
...
![](../../assets/work/one/555.png)

![](../../assets/work/one/006.png) **Действие**
...
![](../../assets/work/one/558.png)

![](../../assets/work/one/006.png) **Действие с новыми платежами**

![](../../assets/work/one/559.png)
...
![](../../assets/work/one/008.png) **Статья расходов/доходов для входящих платежей**

![](../../assets/work/one/560.png)

Позволяет выбрать статью расходов/доходов для входящих платежей из справочника.

![](../../assets/work/one/009.png) **Статья расходов/доходов для исходящих платежей**

![](../../assets/work/one/561.png)

Позволяет выбрать статью расходов/доходов для исходящих платежей из справочника.

![](../../assets/work/one/010.png) **Действие**
