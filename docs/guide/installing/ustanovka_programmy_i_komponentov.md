...
- **Уровень логирования** – указывается уровень детализации логов. Доступны значения:
    ...
    - **Debug** – уровень логирования, при котором логируются ошибки, предупреждения, а также действия пользователя с более детализированной информацией, требуемой для отладки работы;
...
Изменить уровень логирования можно с помощью утилиты ConfigUtility.Wpf.exe. Перейдите в раздел меню Управление ► Утилита настройки служб Parts.Intellect. Уровень изменяется в параметре Общий уровень логирования.
