---
title: Задания на разбор товара
createTime: 2025/05/06 16:48:35
---
Группа разрешений для доступа к документам **Задания на разбор товара**.

![](../../../../../assets/specification/zadaniya_na_razbor_tovara_polzovateli_i_dostupy_1.png)
...
Вывод колонки **Время ввода** в **Задании на разбор товара** доступно только, если включена опция **Включить механизм фиксации времени ввода по позициям задания** в разделе меню **Управление ► Настройки программы ► Настройки ► Склад и закупки ► Задания на склад**.

:::

![](../../../../../assets/specification/image009.png) **Доступ**

Позволяет задать разрешение **Цена поставщика**, влияющее на видимость цены поставщика в документе. 

::: note Заметка

Если видимость цены поставщика запрещена, то в колонке значение цены будет заменено на символы "\*\*\*".

:::

![](../../../../../assets/specification/image010.png) **Доступные действия в документе**

Позволяет задать значение настроек, которые определяют доступность действий над позициями документа в одном из состояний: 

- **Доступные действия для состояния** "**В очереди**";

- **Доступные действия для состояния** "**В работе**";

- **Доступные действия для состояния** "**Выполнено**". 

Доступные значения: **Создать**, **Править**, **Удалить** и **Выбрать все**.

![](../../../../../assets/specification/image011.png) **Обмен данными**
