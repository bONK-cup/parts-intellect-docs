---
title: Корректировки приходных накладных
createTime: 2025/05/06 16:49:55
---
Группа разрешений для доступа к документам **Корректировки приходных накладных**.

![](../../../../../assets/specification/korrektirovki_prikhodnykh_nakladnykh_polzovateli_i_dostupy_1.png)
...
![](../../../../../assets/specification/image169.png)
...
- **Предлагать выбор приоритета на связывание с документами родителями** – при проведении Корректировки приходной накладной программа выдаст уведомление на выбор приоритета списания позиций;
...
![](../../../../../assets/specification/image170.png)
...
- **Можно изменять внешний номер документа после проводки** – после проведения документа пользователю доступно задание и/или редактирование значения в поле **Внешний номер** в параметрах документа.
