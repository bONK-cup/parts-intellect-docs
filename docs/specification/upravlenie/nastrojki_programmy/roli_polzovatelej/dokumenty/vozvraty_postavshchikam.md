...
1  **Запретить проводку документа** – при проводке документа, если позиция была зарезервирована за клиентом, проводка осуществлена не будет. Отобразиться окно: 
