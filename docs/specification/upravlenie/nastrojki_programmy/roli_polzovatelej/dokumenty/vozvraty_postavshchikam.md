...
createTime: 2025/05/06 16:47:35
---
Группа разрешений для доступа к документам **Возвраты поставщикам**.

![](../../../../../assets/specification/vozvraty_postavshchikam_polzovateli_i_dostupy_1.png)
...
![](../../../../../assets/specification/image150.png)
...
- **Предлагать выбор приоритета на связывание с документами родителями** – при проведении возврата поставщику программа выдаст уведомление на приоритет списания позиций для возврата;

![](../../../../../assets/specification/image151.png)

- **Проверять наличие зарезервированных за клиентом позиций** – при проведении документа программа проверит наличие связанных позиций в состояние **Резерв** и, в зависимости от настройки, выдаст уведомление или запретит проводку:

    - **Не осуществлять проверку** – при проводке документа проверка на наличие резерва не будет осуществлена;

    - **Уведомить пользователя** – при проводке документа, если была найдена позиция зарезервированная за клиентом отобразится окно с уведомлением:

    ![](../../../../../assets/specification/image152.png)

    - **Запретить проводку документа** – при проводке документа, если позиция была зарезервирована за клиентом, проводка осуществлена не будет. Отобразиться окно: 

![](../../../../../assets/specification/image153.png)
