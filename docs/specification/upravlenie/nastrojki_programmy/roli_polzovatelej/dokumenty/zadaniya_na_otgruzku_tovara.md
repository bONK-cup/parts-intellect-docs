---
title: Задания на отгрузку товара
createTime: 2025/05/06 16:48:35
---
Группа разрешений для доступа к документам **Задания на отгрузку товара**.

![](../../../../../assets/specification/zadaniya_na_otgruzku_tovara_polzovateli_i_dostupy_1.png)
...
Вывод колонки **Время ввода** в **Задании на отгрузку товара** доступно только, если включена опция **Включить механизм фиксации времени ввода по позициям задания** в разделе меню **Управление ► Настройки программы ► Настройки ► Склад и закупки ► Задания на склад**.
