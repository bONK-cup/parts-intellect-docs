---
title: korrektirovki_raskhodnykh_nakladnykh
createTime: 2025/05/06 16:49:55
---
# Корректировки расходных накладных
Группа разрешений для доступа к документам **Корректировки расходных накладных**.

![](../../../../../assets/specification/image171.png)
...
![](../../../../../assets/specification/image172.png)
...
**Можно изменять номер кор.счф** – позволяет пользователю задавать и/или редактировать значение поля **Номер кор.счф** в параметрах документа;
