...
createTime: 2025/05/06 16:51:50
---
Группа разрешений для доступа к документам **Перемещения товаров**.

![](../../../../../assets/specification/peremeshcheniya_tovarov_polzovateli_i_dostupy_1.png)

![](../../../../../assets/specification/image006.png) **Архив**

![](../../../../../assets/specification/image221.png)
...
![](../../../../../assets/specification/image222.png)
...
![](../../../../../assets/specification/image223.png)
...
![](../../../../../assets/specification/image224.png)
...
![](../../../../../assets/specification/image225.png)
...
![](../../../../../assets/specification/image226.png)
...
- **Можно проводить с количеством, не соответствующим кратности наличия** – определяет способ проверки количества заказываемого товара из наличия на кратность в рамках всего документа:
    ...
    - **Предупреждать** – значение по умолчанию. При несоответствии кратности поле **Кол-во** подсвечивается желтым цветом, а при проводке документа выходит диалоговое окно с доступными действиями:
        ...
        ![](../../../../../assets/specification/image227.png)
...
- **Предлагать выбор приоритета на связывание с документами родителями** – при проведении документа программа выдаст уведомление на приоритет списания позиций;
...
![](../../../../../assets/specification/image228.png)
...
![](../../../../../assets/specification/image229.png)
...
- **Транзитный склад по умолчанию –** указывается склад/торговая точка, который будет автоматически подставлять при создании документа **Перемещение** в поле **Транзитный склад**.

![](../../../../../assets/specification/image014.png) **Цены**

![](../../../../../assets/specification/image230.png)
