...
![](../../../../../assets/specification/image295.png)

![](../../../../../assets/specification/image006.png) **Значение по умолчанию**

![](../../../../../assets/specification/image296.png)
...
![](../../../../../assets/specification/image008.png) **Проверка на совпадение реквизитов**

![](../../../../../assets/specification/image297.png)

Блок содержит настройки, регулирующие проверку на совпадение реквизитов в карточках контрагентов. Программа уведомляет пользователя о наличии контрагента с такими же данными иконкой ![](../../../../../assets/specification/image298.png).
...
![](../../../../../assets/specification/image009.png) **Автомобили контрагентов**

![](../../../../../assets/specification/image299.png)
...
![](../../../../../assets/specification/image010.png) **Обновление реквизитов из сервиса DaData**

![](../../../../../assets/specification/image300.png)
...
Для контрагентов, ИНН или БИК которых были найдены на сервисе, в карточке клиента будут заполнены/ обновлены поля:
- **Отображать как**;
- **Вид контрагента**;
...
![](../../../../../assets/specification/image011.png) **Балансы контрагентов**

![](../../../../../assets/specification/image301.png)
...
![](../../../../../assets/specification/image302.png)

![](../../../../../assets/specification/image012.png) **Отсрочка и штрафы**

![](../../../../../assets/specification/image303.png)
...
- **Способ начисления штрафа** – позволяет задать способ разнесения суммы штрафа в документе:
    ...
    - **Наценка на цену продажи** – позволяет изменить значение **Цена продажи с НДС** по позициям;
    
    - **Наценка на цену продажи с округлением** – позволяет изменить значение **Цена продажи с НДС** по позиции с применением заданного округления для валюты документа.
