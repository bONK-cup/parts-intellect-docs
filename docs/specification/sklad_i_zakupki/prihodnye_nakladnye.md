...
**Панель инструментов** позволяет осуществить над документами типа **Приходные накладные** ряд действий:
...
![](../../assets/specification/sklad_i_zakupki_prikhodnye_nakladnye_1.png)
