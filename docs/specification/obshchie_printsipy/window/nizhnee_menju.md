...
- установленный и подключенный [**Сервер Parts.Intellect**](../../../work/server/podklyuchenie_k_serveru.md).
...
- **Индикатор состояний** – по нажатию на общий значок индикатора отображается информация о состоянии работоспособности некоторых служб:
   ...
   Установка сервиса описана в разделе [Установка Сервера Parts.Intellect](../../../work/server/ustanovka_servera.md)
