...
![](Aspose.Words.6f13226c-9016-4dda-be57-653ed66d987a.010.png)

**»** Нажмите кнопку **Далее**. Откроется окно лицензионного соглашения.

![](Aspose.Words.6f13226c-9016-4dda-be57-653ed66d987a.011.png)
...
![](Aspose.Words.6f13226c-9016-4dda-be57-653ed66d987a.014.png)
...
![](Aspose.Words.6f13226c-9016-4dda-be57-653ed66d987a.015.png)
...
![](Aspose.Words.6f13226c-9016-4dda-be57-653ed66d987a.016.png)
...
|||
| :- | :- |
||Для уменьшения количества записей в журнале логирования выполняется отключение XPO-логов. В файлах exe config в блоке: **<switches>**,  пункт: **<add name="XPO" value="\*\*"/>** вместо **\*\*** – проставить значение **2** (выключить)/ **3** (включить). <switches><dd name=''"XPO" value="2"/></switches>По умолчанию логирование включено для всех exe config-файлов, кроме "Tradesoft.Parts.Intellect.Automate.exe.config".|
|||

**»** Нажмите команду **Сохранить**. Откроется окно, уведомляющее об успешном обновлении конфигурации.

![](Aspose.Words.6f13226c-9016-4dda-be57-653ed66d987a.017.png)

**»** Нажмите команду **Ок**. Откроется окно подтверждения завершения установки.

![](Aspose.Words.6f13226c-9016-4dda-be57-653ed66d987a.018.png)
